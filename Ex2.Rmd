...
<p align="center"><img src= "Images/arcgis-new-project.png" alt="Project name and location" style="width:100%"></p><br>
...
<p align="center"><img src= "Images/arcgis-add-data.png" alt="Add data" style="width:100%"></p><br>
...
<table style="width:100%;margin-left:auto;margin-right:auto;">
  ...
  <tr>
    <td><li>Corrections</li></td>
    <td>Set grid corrections and offset</td>
  </tr>
  <tr>
    <td><li>X,Y Coordinates</li></td>
...
<p align="center"><img src= "Images/arcgis-explore-tool.png" alt="Explore" width="320" height="270"></p><br>
...
2. Add the data to your layers
3. Use the symbology tab to color the counties by number of tornadoes (**tornado_co**)
4. Map out the data including all the necessary elements added above
