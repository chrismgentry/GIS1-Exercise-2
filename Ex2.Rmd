...
<p align="center"><img src= "Images/r-github-ipy-location.png" alt="Finding the Google Colab file on GitHub" width="743" height="322"></p>
<br>
...
<p align="center"><img src= "Images/r-github-tocolab.png" alt="Converting ipy file to colab" width="765" height="395"></p>
<br>
...
<p align="center"><img src= "Images/r-colab.png" alt="Converting ipy file to colab" width="760" height="174"></p>
<br>
...
<p align="center"><img src= "Images/r-colab-code-text.png" alt="Adding Text or Code Blocks" width="764" height="18"></p>
<br>
...
<p align="center"><img src= "Images/r-colab-block-settings.png" alt="Edit block properties" width="762" height="200"></p>
<br>
...
<p align="center"><img src= "Images/github-data-download.png" alt="Data Download from GitHub" width="510" height="200"></p><br>
...
<p align="center"><img src= "Images/qgis-temp.png" alt="QGIS Start Screen" width="800" height="240"></p><br>
...
<p align="center"><img src= "Images/qgis-proj.png" alt="QGIS Start Screen" width="800" height="240"></p><br>

In the _Browser_ window on the left, navigate to the folder where you saved and unzipped the exercise data folder. Once you locate a folder in folder in the browser, you can use control+click (macOS) or right-click (PC) to **Add as a favorite**. This will link it to the favorites drop-down in the browser window giving you quicker future access. To add the data, you will navigate to the **ev_data.shp** file and then click-and-drag it to the map canvas. If there is a pop-up window that mentions transformations go ahead and click OK. This will be discussed further in a couple weeks after a lecture on projections and coordinate systems. For now, leave it with option 1 and click OK.

<p align="center"><img src= "Images/qgis-transformations.png" alt="QGIS Start Screen" width="800" height="400"></p><br>
...
<p align="center"><img src= "Images/qgis-states.png" alt="QGIS Map Canvas" width="800" height="240"></p><br>

You can now begin to explore some of the basic tools for navigating the _map canvas_ such as:

- Zoom in and out with the _Fixed Zoom Tools_ <img src= "Images/qgis-fixed-zoom.png" alt="Fixed Zoom Tools" width="40" height="20">
- _Pan tool_ to postion the map on the screen <img src= "Images/qgis-pan.png" alt="Pan Tool" width="20" height="20">
- _Map scale_ where you can adjust the map scale (level of zoom) manually
- _Zoom full_ button which will adjust the view to accommodate all datasets <img src= "Images/qgis-full-extent.png" alt="Zoom Full" width="20" height="20">
...
<p align="center"><img src= "Images/qgis-tennessee.png" alt="Identify Cursor" width="800" height="240"></p><br>
...
<p align="center"><img src= "Images/qgis-attributes.png" alt="Attribute Table" width="800" height="240"></p><br>
